...
int main()	{
	...
	text_posm.x = 5;
	text_posm.y = 10;
	text_posm.w = msg_score_max_surface->w;// Largeur du texte_score_max en pixels (à récupérer)
	text_posm.h = msg_score_max_surface->h;// Hauteur du texte_score_max en pixels (à récupérer)
	...
	text_pos.x = 5;
	text_pos.y = 40;
	text_pos.w = msg_score_surface->w;// Largeur du texte_score_max en pixels (à récupérer)
	text_pos.h = msg_score_surface->h;// Hauteur du texte_score_max en pixels (à récupérer)
	...
	text_pos_menu.x = 100;
	text_pos_menu.y = 300;
	text_pos_menu.w = 400;// Largeur du texte_score_max en pixels (à récupérer)
	text_pos_menu.h = msg_menu_surface->h;// Hauteur du texte_score_max en pixels (à récupérer)
